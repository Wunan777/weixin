...
var _annual = __webpack_require__(36);
...
var app = new Vue({
    ...
    methods: {
        ...
        setYearArr: function setYearArr(name, selectName, data) {
            var me = this;
            var arr = [];
        ...
        createMajorGraph: function createMajorGraph(year) {
            var me = this;
        ...
        createCenterGraph: function createCenterGraph(year) {
            var me = this;
    ...
    watch: {
        majorSelectYear: function majorSelectYear(val, oldVal) {
            this.createMajorGraph(val);
        },
        centerSelectYear: function centerSelectYear(val, oldVal) {
